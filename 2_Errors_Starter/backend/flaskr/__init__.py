...
def create_app(test_config=None):
    ...
    @app.errorhandler(400) #takes the status code as an argument
    def bad_request(error):#naming of function handler
    ...
    @app.errorhandler(404) #takes the status code as an argument
